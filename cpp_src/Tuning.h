...
const double temperament_preset[TUNING_PRESETS][PRESETS_LENGTH] =
{
	...
	{ 1, 1.053497, 1.119929, 1.185185, 1.254242, 1.333333, 1.404663, 1.496616, 1.580246, 1.676105, 1.777777, 1.877119, 2 },
	...
	{ 1, 1.053497, 1.118144, 1.185185, 1.250031, 1.333333, 1.404663, 1.496112, 1.580246, 1.672002, 1.777777, 1.872885, 2 },

	//Atom Schisma Scale
	{ 1, 1.059459, 1.122463, 1.189204, 1.259924, 1.334838, 1.414207, 1.498308, 1.587396, 1.681796, 1.781794, 1.887755, 2 },

	//12 - tET approximation with minimal order 17 beats
	{ 1, 1.058823, 1.125000, 1.187500, 1.250000, 1.333333, 1.416666, 1.500000, 1.588235, 1.666666, 1.777777, 1.888888, 2 },

	//Paul Bailey's modern well temperament (2002)
	{ 1, 1.054892, 1.119671, 1.186774, 1.254242, 1.335183, 1.406531, 1.498302, 1.582329, 1.676250, 1.780202, 1.881407, 2 },

	//John Barnes' temperament (1977) made after analysis of Wohltemperierte Klavier, 1/6 P
	{ 1, 1.055880, 1.119929, 1.187865, 1.254242, 1.336348, 1.407840, 1.496616, 1.583819, 1.676105, 1.781797, 1.881364, 2 },

	//Bethisy temperament ordinaire, see Pierre - Yves Asselin : Musique et temperament
	{ 1, 1.051418, 1.118034, 1.181509, 1.250000, 1.331953, 1.403475, 1.495348, 1.575346, 1.671850, 1.774101, 1.872884, 2 },

	//Big Gulp
	{ 1, 1.031250, 1.125000, 1.166666, 1.250000, 1.312500, 1.375000, 1.500000, 1.546875, 1.687500, 1.750000, 1.875000, 2 },

	//12 - tone scale by Bohlen generated from the 4:7 : 10 triad, Acustica 39 / 2, 1978
	{ 1, 1.100000, 1.200000, 1.304347, 1.428571, 1.571428, 1.750000, 1.909090, 2.100000, 2.300000, 2.500000, 2.750000, 3 },

	//This scale may also be called the "Wedding Cake"
	{ 1, 1.125000, 1.171875, 1.250000, 1.333333, 1.406250, 1.500000, 1.562500, 1.666666, 1.687500, 1.777777, 1.875000, 2 },

	//Upside - Down Wedding Cake(divorce cake)
	{ 1, 1.066666, 1.125000, 1.200000, 1.280000, 1.333333, 1.500000, 1.600000, 1.687500, 1.777777, 1.800000, 1.920000, 2 },

	//12 - tone Pythagorean scale
	{ 1, 1.067871, 1.125000, 1.185185, 1.265625, 1.333333, 1.423828, 1.500000, 1.601806, 1.687500, 1.777777, 1.898437, 2 },
	...
	{ 1, 1.071428, 1.125000, 1.166666, 1.250000, 1.333333, 1.406250, 1.500000, 1.607142, 1.666666, 1.750000, 1.875000, 2 },

	//Bach temperament, a'=400 Hz
	{ 1, 1.052192, 1.118997, 1.183716, 1.250521, 1.334029, 1.402922, 1.498956, 1.578288, 1.670146, 1.776618, 1.874739, 2 },

	//Vallotti& Young scale(Vallotti version) also known as Tartini - Vallotti(1754)
	{ 1, 1.055880, 1.119929, 1.187865, 1.254242, 1.336348, 1.407840, 1.496616, 1.583819, 1.676105, 1.781797, 1.877119, 2 },

	//Vallotti - Young and Werckmeister III, 10 cents 5 - limit lesfip scale
	{ 1, 1.051637, 1.117298, 1.187060, 1.248356, 1.336846, 1.399836, 1.495457, 1.580099, 1.669531, 1.783574, 1.867613, 2 },

	//Optimally consonant major pentatonic, John deLaubenfels(2001)
	{ 1, 1.118042, 1.250019, 1.496879, 1.670166, 2 },

	//Ancient Greek Aeolic, also tritriadic scale of the 54:64 : 81 triad
	{ 1, 1.125000, 1.185185, 1.333333, 1.500000, 1.580246, 1.777777, 2 },

	//African Bapare xylophone(idiophone; loose log)
	{ 1, 1.076737, 1.200942, 1.336382, 1.497441, 1.670175, 1.932988, 2.174725, 2.285484, 2.525670, 2.738400 },

	//African Yaswa xylophones(idiophone; calbash resonators with membrane)
	{ 1, 1.128312, 1.271619, 1.486239, 1.707240, 1.936341, 2.015074, 2.215296, 2.419988, 2.871225, 3.220980 },
...
/*
	...
	const TTuning dist_a_pure{ 4, 2, 9, 2 };
